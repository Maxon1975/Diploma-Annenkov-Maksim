# Дипломный проект профессии «Тестировщик программного обеспечения                                                                                         (https://github.com/netology-code/qa-diploma/blob/master/README.md "Задание на дипломную работу")
